...
\begin{sazetak}
Završni rad razmatra izradu web aplikacije za praćenje rankinga sveučilišta u područjima \emph{Computer Science \& Engineering (CSE)} i 
\emph{Electrical \& Electronic Engineering (EEE)} prema algoritmu Shanghai Ranking sustava.
Web aplikacija rješava problem nedostupnosti ranking podataka za niže rangirana sveučilišta te nudi praćenje procjene rankinga za trenutnu godinu prije nego što 
izađe službena Shanghai Ranking rang lista. Korisniku nudi tablični prikaz procijenjene rang liste s vrijednostima indikatora koji se koriste za izračun rankinga,
grafički prikaz promjene ranking podataka odabranog sveučilišta, usporedbu procjene rankinga sa Shanghai Ranking podatcima te pretragu baze podataka prema imenu sveučilišta.
...
procjena rankinga, Docker, grafički prikaz ranking podataka}
\end{sazetak}
\newpage
% TODO: Navedite naslov na engleskom jeziku.
\engtitle{An application for monitoring the ranking of universities according to the Shanghai List}
\begin{abstract}
Final work considers the creation of a web application for monitoring university rankings in the fields of Computer Science \& Engineering (CSE) and
Electrical \& Electronic Engineering (EEE) according to the Shanghai Ranking system algorithm.
The web application solves the problem of the unavailability of ranking data for lower-ranked universities and offers monitoring of the ranking assessment for the current year before
