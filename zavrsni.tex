...
\begin{figure}[htb]
    ...
    \label{fig:homepage}
    \end{figure}
Početna stranica nalazi se na putanji "/". Na početnoj stranici korisnik može birati između tri opcije. Klikom na neki od gornja dva gumba \emph{CSE} ili \emph{EEE}
...
Klikom na donji gumb \emph{UPLOAD STVARNIH RANKING PODATAKA} korisnik će biti preusmjeren na stranicu na kojoj može objaviti .xlsx datoteku koja ima 
...
Klikom na neki od gumba \emph{CSE} ili \emph{EEE} korisniku se prikaže stranica na slici \ref{fig:tablica}. Putanja koja vodi do ove stranice 
...
za odabir godine za koju korisnik želi pogledati procjenu rankinga sveučilišta. Klikom na tu komponentu prikazuje se padajući izbornik 
...
Shanghai Ranking. Kada korisnik odabere jednu od ponuđenih godina u URL-u se mijenja parametar \emph{year}, šalje se GET zahtjev na \emph{backend}
poslužitelj te se ažurira tablica procjene rankinga s podatcima za odabranu godinu.\newpage Ispod komponete za odabir goidne, a prije tablice rankinga
nalazi se polje za pretragu sveučilišta po njihovom imenu. Upisom imena sveučilišta u tablici za procjenu rankinga pojavit će se podatci samo za ona sveučilišta
koja u imenu sadrže podniz koji je korisnik upisao u polje za pretragu.
