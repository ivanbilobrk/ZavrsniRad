...
\begin{figure}[htb]
    ...
    \caption{Grafički prikaz odstupanja procijenjenih vrijednosti indikatora i ukupne vrijednosti \engl{total} za 2022. godinu}
    \label{fig:graf2022}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htb]
        ...
        \caption{Grafički prikaz odstupanja procijenjenih vrijednosti indikatora i ukupne vrijednosti \engl{total} za 2021. godinu}
        \label{fig:graf2021}
        \end{figure}   
        \FloatBarrier 
...
Aplikacija rješava problem nedostupnosti uvida u rang i vrijednosti indikatora za niže rangirana sveučilišta na stranici Shanghai Ranking te nudi praćenje procijenjenih vrijednosti indikatora i ranga za trenutnu godinu prije nego što 
